...
function Cart() {
  ...
  async function enviarPedido() {
    ...
    try {
      ...
      window.open(
        `https://api.whatsapp.com/send?phone=5538998017215&text=${encodeURIComponent(msg)}`,
        "_blank",
      );
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            >
              ...
              <p
                style={{ color: "#666", marginTop: "10px", fontWeight: "500" }}
              >
